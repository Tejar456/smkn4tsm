  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
      ...
      <p class="mt-1 text-gray-600">
        Program kehlaian yang ada di SMKN 4 Tasikmalaya
      </p>
    </div>
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-2">
      ...
      >
        <div class="flex items-center gap-5">
          ...
          >
            <svg
              ...
              viewBox="-23.63 -23.63 141.76 141.76"
              xml:space="preserve"
              stroke="#ffffff"
            >
          ...
          <div>
            <h3
              class="group-hover:text-gray-600 text-lg font-semibold text-gray-800"
            >
              PPLG
            </h3>
          </div>
        ...
        <div class="mt-5">
          <p class="mt-1 text-gray-600">
            Pengembangan Perangkat Lunak dan Game berfokus pada pembuatan
      ...
      >
        <div class="flex items-center gap-5">
          ...
          >
            <svg
              viewBox="-276.48 -276.48 1576.96 1576.96"
              class="icon"
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
              fill="#000000"
        ...
        <div class="flex items-center gap-5">
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink"
              viewBox="-99.21 -99.21 481.88 481.88"
              xml:space="preserve"
              stroke="#ffffff"
            >
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
      ...
      >
        ...
        <div class="mt-5">
          <p class="mt-1 text-gray-600">
            Desain Komunikasi Visual berfokus pada Fotografi dan Videografi
